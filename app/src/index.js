...
function run()
{
	...
	console.log('wem: run() [environment:%s]', process.env.NODE_ENV);
	...
	console.log('wem: device = ', deviceInfo());

	console.log('wem: detectDevice = ', detectDevice());
	...
	if (detectDevice() === undefined)
	{
		...
		console.log('wem: unsupportedBrowser1 = true;');
	}
	else if (
	...
	)
	{
		...
		console.log('wem: webrtcUnavailable = true;');
	...
	)
	{
		...
		unsupportedBrowser = true;
		console.log('wem: unsupportedBrowser2 = true;');
